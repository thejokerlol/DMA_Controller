...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-6756-G-TIRUPATHI/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-6756-G-TIRUPATHI/realtime/DMA_Controller_synth.xdc
    rt::sdcChecksum
    set rt::top DMA_Controller
    ...
    rt::set_parameter webTalkPath {C:/Users/vamsi/Desktop/DMA_Controller_Project/DMA_Controller/DMA_Controller.cache/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-6756-G-TIRUPATHI/"
    if {$rt::useElabCache == false} {
